...
public class CartoonFrameSprite : MonoBehaviour
{
	...
	{
		m_textureWidth = m_width * base.GetComponent<Renderer>().sharedMaterial.mainTexture.width / m_subdivisionsX;
		m_textureHeight = m_height * base.GetComponent<Renderer>().sharedMaterial.mainTexture.height / m_subdivisionsY;
